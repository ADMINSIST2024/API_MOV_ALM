...
{
    [ApiController]
    [ApiVersion("2.0")] // Versión 2
    [Route("api/v{version:apiVersion}/[Controller]")]
    public class AltaV2Controller : ControllerBase
    {
        ...
        public AltaV2Controller(IAltaRepository<Alta> AltaRepository, IAlmacenRepository<Almacen> AlmacenRepository, IGeneralRepository<General> GeneralRepository)
        {
        ...
        [HttpPost]
        public IActionResult Lectura(ProcesoLecturaEtiquetaDtoInputs obj)
        {
